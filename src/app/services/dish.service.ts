...
export class DishService {
  ...
  //Access backend via auto-generated API endpoints, created by Firebase
  ...
  postComment(dishId: string, comment: any): Promise<any> {
    if (this.currentUser) {
      //nesting collection of comments within dish document
  ...
  getComments(dishId: string): Observable<any> {
    //not requiring id's so only use .valueChanges()
